...
function computeSeniorityScore(cv: string, job: string, cvYears: number, requiredYears: number) {
...
function computeKeywordScore(cv: string, job: string) {
...
function computeContextScore(cv: string, job: string, pageUrl: string, location: string) {
  let score = 6;
...
function buildStrengths(matchedSkills: string[], matchedRoles: string[], cvYears: number, requiredYears: number) {
...
function buildActions(score: number, missingSkills: string[], jobSkills: string[], matchedSkills: string[]) {
